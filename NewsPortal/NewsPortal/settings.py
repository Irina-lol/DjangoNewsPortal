...
SECRET_KEY = 'django-insecure-dqz8vh)nwcqbs+iqh#v5xwbw0ck9m#ubd6z@+^wo1toq-ri6-s'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'django.request': {
            'handlers': ['News', 'News2', 'mail_admins'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'django.server': {
            'handlers': ['News2', 'mail_admins'],
            'level': 'ERROR',
            'propagate': True,
        },
        'django.template': {
...
MANAGERS = [
    ('irina', 'irinakazynkina@yandex.ru'),
]
